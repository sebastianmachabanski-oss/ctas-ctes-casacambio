...
echo "🔧 Creando pantalla de Deudores..."

mkdir -p src/app/dashboard/deudores

cat > src/app/dashboard/deudores/page.tsx << 'EOF'
...
echo "✅ Pantalla Deudores creada"
echo ""
echo "Ejecutá:"
echo "  git add ."
echo "  git commit -m 'feat: pantalla deudores con totales'"
echo "  git push"
