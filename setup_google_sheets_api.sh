...
echo "🔧 Configurando lectura directa desde Google Sheets API..."

# ══════════════════════════════════════════════════════════════════
# API Route: leer Google Sheets directamente (sin descarga de Excel)
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# Scheduled function usando Google Sheets API
# ══════════════════════════════════════════════════════════════════
...
echo "✅ Google Sheets API configurada"
echo ""
echo "Antes del push agregá en Netlify:"
echo "  SUPABASE_SERVICE_ROLE_KEY = (service role key de Supabase → Project Settings → API)"
echo ""
echo "Luego:"
echo "  git add ."
echo "  git commit -m 'feat: Google Sheets API + sync automatico 15min'"
echo "  git push"
