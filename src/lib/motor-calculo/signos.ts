...
const MONEDAS = ['PESOS', 'CHEQUES', 'DOLARES', 'EUROS', 'REALES'] as const

// Matriz mult[propia][externa] tal como está cargada en SIGNOS (30 combinaciones: 5 sin
// externa + 5x5 pares). NADA = no hay conversión (mismas monedas, o sin externa); POR =
// multiplicar por la cotización; DIV = dividir por la cotización.
const MATRIZ_MULT: Record<string, Record<string, MultCotizacion>> = {
  PESOS:   { PESOS: 'NADA', CHEQUES: 'NADA', DOLARES: 'DIV', EUROS: 'DIV', REALES: 'DIV' },
  CHEQUES: { PESOS: 'NADA', CHEQUES: 'NADA', DOLARES: 'DIV', EUROS: 'DIV', REALES: 'DIV' },
  DOLARES: { PESOS: 'POR',  CHEQUES: 'POR',  DOLARES: 'NADA', EUROS: 'DIV', REALES: 'POR' },
  EUROS:   { PESOS: 'POR',  CHEQUES: 'POR',  DOLARES: 'POR',  EUROS: 'NADA', REALES: 'POR' },
  REALES:  { PESOS: 'POR',  CHEQUES: 'POR',  DOLARES: 'DIV',  EUROS: 'DIV',  REALES: 'NADA' },
}
