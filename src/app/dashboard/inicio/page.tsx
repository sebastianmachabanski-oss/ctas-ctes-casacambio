...
export default async function InicioPage({
  ...
  // caja" de la planilla). Coincide con filtrar la planilla por ese mismo período.
  const kpis = [
    { cur: 'Pesos',   col: '#2563eb', caja: t.pesos ?? 0,   calle: calle.pesos,   enCaja: (t.pesos ?? 0) - calle.pesos,     cc: t.cc_pesos ?? 0 },
